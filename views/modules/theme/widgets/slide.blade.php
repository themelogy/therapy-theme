        ...
        <ul>
            ...
            <li data-index="rs-{{ $loop->iteration }}"
                ...
                <div class="tp-caption tp-resizeme tp-caption-theme"
                     ...
                     data-x="{{ @$slide->settings->title_position_h ?? 'left' }}" data-hoffset="{{ @$slide->settings->title_position_x ?? '100' }}"
                     data-y="{{ @$slide->settings->title_position_v ?? 'center' }}" data-voffset="{{ @$slide->settings->title_position_y ?? '-50' }}"
                     ...
                     data-color="{{ @$slide->settings->title_color ?? '#000000' }}"
