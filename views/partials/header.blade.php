    ...
    <div class="header12 po-relative">
                ...
                <nav class="navbar navbar-expand-lg font-14">
                    ...
                    <div class="collapse navbar-collapse" id="header12">
                        @component('partials.components.socials')
                            <li><a href="tel:{{ setting('theme::phone') }}"><i class="icon icon-Phone-2 font-bold"></i> {{ setting('theme::phone') }}</a></li>
                        @endcomponent
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-default navbar-expand-lg hover-dropdown h12-nav">
                <a class="navbar-brand" href="{{ LaravelLocalization::getLocalizedURL(locale(), url(locale())) }}"><img src="{!! Theme::url('images/logo/logo.svg') !!}" alt="{{ setting('theme::company-name') }}" /></a>
